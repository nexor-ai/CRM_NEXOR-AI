-- Fix PL/pgSQL ambiguity between RETURNS TABLE output names and table columns.
-- Constraint-based ON CONFLICT and qualified predicates keep the atomic claim
-- valid when a due campaign exists.
