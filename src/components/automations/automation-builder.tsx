...
const TRIGGER_OPTIONS: { value: AutomationTriggerType; label: string; hint: string }[] = [
  { value: "new_message_received", label: "Nova mensagem recebida", hint: "Qualquer mensagem recebida" },
  {
    ...
    hint: "Primeira vez que este contato te envia mensagem (vale também para contatos adicionados manualmente)",
  },
  { value: "keyword_match", label: "Palavra-chave", hint: "A mensagem contém palavra(s)-chave específica(s)" },
  ...
  { value: "time_based", label: "Por horário", hint: "Em um agendamento recorrente" },
]
