      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription className="text-muted-foreground">
            Encerre a sessão em todos os dispositivos onde você está conectado —
            inclusive este. Útil se você perdeu um notebook ou compartilhou sua senha.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Button
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              precisarão entrar novamente. Você será redirecionado para a tela de login
              page.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
