...
export function ProfileForm() {
  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success(
        emailSent
          ? 'Perfil salvo — confira seu e-mail para confirmar a alteração do endereço'
          : 'Perfil salvo',
      );
    } catch (err) {
  ...
  return (
    <section className="max-w-2xl animate-in fade-in-50 duration-200">
      <SettingsPanelHead
        title="Seu perfil"
        description="Como você aparece no aplicativo. Seu avatar e nome aparecem no cabeçalho, na barra lateral e em qualquer lugar onde seus colegas veem você."
      />
