...
export function InviteMemberDialog({
  ...
  function whatsappShareUrl(url: string): string {
    ...
    const message = `Entre em ${accountName} usando este link (válido por ${result?.expiresInDays} dias): ${url}`;
          ...
          <>
            <DialogHeader>
              ...
              <DialogDescription className="text-muted-foreground">
                ...
                <span className="font-medium text-muted-foreground">{ROLE_PT[result.role]}</span>
                . O link é válido por{' '}
            ...
            <div className="space-y-3 py-2">
              ...
              <div className="rounded-md border border-amber-500/50 bg-amber-500/15 px-3 py-2 text-xs text-amber-200">
                ...
                Nunca armazenamos o texto puro — assim que você fechar este diálogo,
                a URL desaparece. Para compartilhar de novo, revogue este convite e crie
                um novo.
              </div>
          ...
          <>
            <DialogHeader>
              ...
              <DialogDescription className="text-muted-foreground">
                ...
                Slack ou qualquer canal que preferir — sem precisar de serviço de e-mail.
              </DialogDescription>
            </DialogHeader>
