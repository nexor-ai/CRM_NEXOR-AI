...
const TEMPLATE_ICON: Record<TemplateSlug, typeof Zap> = {
  ...
  catalog_request: BookOpen,
  new_contact_onboarding: UserRoundPlus,
  assignment_confirmation: UserCheck,
  daily_reengagement: RefreshCcw,
};
...
export default function AutomationsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <section aria-labelledby="automation-template-library">
        <div className="mb-3 flex items-end justify-between gap-3">
          <div>
            <h2
              id="automation-template-library"
              className="text-foreground text-sm font-semibold"
            >
              Biblioteca quick-start
            </h2>
            <p className="text-muted-foreground mt-1 text-xs">
              Use um modelo como ponto de partida e personalize antes de ativar.
            </p>
          </div>
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              <span className="text-foreground">{pendingDelete?.name}</span> e
              seu histórico de execução. Esta ação não pode ser desfeita.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
            <Button
      ...
      <div className="flex items-center gap-4 p-4">
        ...
        >
          ...
          <div className="text-muted-foreground mt-2 flex flex-wrap items-center gap-2 text-xs">
            ...
            <span>última exec. {formatRelative(automation.last_executed_at)}</span>
          </div>
        </button>
