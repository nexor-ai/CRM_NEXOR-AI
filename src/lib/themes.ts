...
export const THEMES: ReadonlyArray<ThemeMeta> = [
  ...
  },
  {
    id: "emerald",
    name: "Esmeralda",
    tagline: "Cara de crescimento, remete a mensageria sem copiar o verde do WhatsApp.",
    swatch: "oklch(0.62 0.16 162)",
  },
  {
    id: "cobalt",
    name: "Cobalto",
    tagline: "Azul limpo de SaaS B2B — calmo e com cara de produto.",
    swatch: "oklch(0.585 0.2 254)",
  },
  {
    id: "amber",
    name: "Âmbar",
    tagline: "Caloroso e amigável — combina com equipes de PMEs.",
    swatch: "oklch(0.745 0.16 65)",
  },
  {
    id: "rose",
    name: "Rosé",
    tagline: "Ousado e moderno — D2C, economia de criadores, lifestyle.",
